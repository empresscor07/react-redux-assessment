...
export default function FilterEvents({showInviteFilter, handleFilterInviteClose, handleFilterInvites}) {
    ...
    function handleFilterSubmit(event) {
        ...
        handleFilterInviteClose()
        handleFilterInvites({window_start, window_end})
    }
    ...
    return (
        <Modal show={showInviteFilter} onHide={handleFilterInviteClose}>
            <Modal.Header closeButton>
                <Modal.Title>Filter Invites:</Modal.Title>
            </Modal.Header>
